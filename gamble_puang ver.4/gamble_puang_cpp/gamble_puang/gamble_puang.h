...
{
	P_none, P_blackjack, P_poker, P_slotmachine, P_holzzak, P_horse, P_boonsu, P_mart, P_snake, P_packman
};
...
extern string t_BJ_rule[17];
extern string t_horse_rule[13];
extern string t_holzzak_rule[16];
extern string t_poker1_rule[13];
extern string t_poker2_rule[18];
extern string t_slotmachine_rule[17];
